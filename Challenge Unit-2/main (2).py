...
Include methods to 
Deposit money withdraw money and display the account balance. Ensure 
that the account balance 
cannot be accessed directly from outside the class. Write a program to 
create an instant of the 
...
account = BankAccount(account_number="123456789",
                        account_holder_name= "Sharon Xavier",
